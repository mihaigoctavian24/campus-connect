...
export const qrCheckInSchema = z.object({
  ...
  locationHash: z.string()
    .optional(), // For future geolocation verification
});
...
export const reviewHoursSchema = z.object({
  hoursRequestId: z.string()
    .uuid('Invalid hours request ID'),
  ...
  approvedHours: z.number()
    ...
    .optional(), // Allow professor to adjust hours
