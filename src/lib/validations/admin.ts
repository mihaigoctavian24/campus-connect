...
export const createDepartmentSchema = z.object({
  ...
  code: z.string()
    ...
    .regex(/^[A-Z0-9_-]+$/, 'Department code can only contain uppercase letters, numbers, underscores, and hyphens'),
...
export const updateSystemSettingsSchema = z.object({
  ...
  defaultApplicationDeadlineDays: z.number()
    .int()
  ...
  // Session settings
  defaultSessionReminderHours: z.number()
    .int()
    .min(1, 'At least 1 hour before')
    .max(168, 'Maximum 168 hours (7 days) before')
    .optional(),

  qrCodeExpirationMinutes: z.number()
    .int()
  ...
  certificateAutoGenerate: z.boolean()
    .optional(),

  certificateRequireMinimumHours: z.boolean()
    .optional(),
