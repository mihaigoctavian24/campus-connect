...
export const generateCertificateSchema = z.object({
  ...
  includeDetails: z.boolean().default(true), // Include detailed activity description

  includeHours: z.boolean().default(true), // Include hours breakdown
...
export const certificateTemplateSchema = z.object({
  ...
  variables: z.array(z.string()).max(50, 'Maximum 50 variables allowed').optional(), // Available template variables like {{student_name}}, {{activity_title}}
